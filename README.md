...
This application is configured with keycloak authentication. It will refuse to start without keycloak started 
...
To build the final jar and optimize the hrms_gateway application for production, run:
