...
import { UserApplicationDeleteDialogComponent } from 'app/entities/dataapp/user-application/user-application-delete-dialog.component';
import { UserApplicationService } from 'app/entities/dataapp/user-application/user-application.service';
