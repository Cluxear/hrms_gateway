package com.tw.gateway.repository;

import com.tw.gateway.HrmsGatewayApp;

import com.tw.gateway.config.Constants;
import com.tw.gateway.config.TestSecurityConfiguration;
import com.tw.gateway.config.audit.AuditEventConverter;
import com.tw.gateway.domain.PersistentAuditEvent;
...
import static com.tw.gateway.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;

/**
 * Integration tests for {@link CustomAuditEventRepository}.
 */
@SpringBootTest(classes = {HrmsGatewayApp.class, TestSecurityConfiguration.class})
@Transactional
